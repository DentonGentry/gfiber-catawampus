...
class NetdevStatsMrvl88601(ETHERNET.Interface.Stats):
  ...
  def __init__(self, stat_dir):
    ...
    type(self).ErrorsReceived.Set(
        self,
        self._ReadStatFile('rx_bad_fc') +
        self._ReadStatFile('rx_undersized') +
        self._ReadStatFile('rx_fragments') +
        self._ReadStatFile('rx_oversized') +
        self._ReadStatFile('rx_jabber') +
        self._ReadStatFile('rx_mac_error') +
        self._ReadStatFile('rx_crc_error') +
        self._ReadStatFile('rx_bad_packets'))
