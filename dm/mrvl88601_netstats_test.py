...
class NetStatsTest(unittest.TestCase):
  ...
  def testInterfaceStatsGood(self):
    ...
    self.assertEqual(eth.BytesReceived, 0)
    self.assertEqual(eth.BytesSent, 0)
    self.assertEqual(eth.DiscardPacketsReceived, 102)
    ...
    self.assertEqual(pon.BytesReceived, 0)
    self.assertEqual(pon.BytesSent, 0)
    self.assertEqual(pon.DiscardPacketsReceived, 202)
    self.assertEqual(pon.DiscardPacketsSent, 0)
    self.assertEqual(pon.ErrorsReceived, 0)
